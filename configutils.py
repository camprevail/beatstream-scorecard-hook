...
if not os.path.isfile('config.ini'):
    ...
    config.set('Keybinds', '# the lookup table here https://www.foreui.com/articles/Key_Code_Table.htm')
    config.set('Keybinds', '# Mapped to ~`, 1, 2, 3, 4, by default.')
    config.set('Keybinds', 'current stage', '192')
...
def update_file():
    ...
    newconfig.set('Keybinds', '# the lookup table here https://www.foreui.com/articles/Key_Code_Table.htm')
    newconfig.set('Keybinds', '# Mapped to ~`, 1, 2, 3, 4, by default.')
